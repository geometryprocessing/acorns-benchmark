...
double def_grad[0][0] = (def_grad[0][0]) + ((grads[(((0) + ((p) * (2))) * (3)) + (0)]) * (local_disp[0]));
double def_grad[1][0] = (def_grad[1][0]) + ((grads[(((0) + ((p) * (2))) * (3)) + (0)]) * (local_disp[1]));
double def_grad[2][0] = (def_grad[2][0]) + ((grads[(((0) + ((p) * (2))) * (3)) + (0)]) * (local_disp[2]));
double def_grad[0][0] = (def_grad[0][0]) + ((grads[(((1) + ((p) * (2))) * (3)) + (0)]) * (local_disp[3]));
double def_grad[1][0] = (def_grad[1][0]) + ((grads[(((1) + ((p) * (2))) * (3)) + (0)]) * (local_disp[4]));
double def_grad[2][0] = (def_grad[2][0]) + ((grads[(((1) + ((p) * (2))) * (3)) + (0)]) * (local_disp[5]));
double def_grad[0][1] = (def_grad[0][1]) + ((grads[(((0) + ((p) * (2))) * (3)) + (1)]) * (local_disp[0]));
double def_grad[1][1] = (def_grad[1][1]) + ((grads[(((0) + ((p) * (2))) * (3)) + (1)]) * (local_disp[1]));
double def_grad[2][1] = (def_grad[2][1]) + ((grads[(((0) + ((p) * (2))) * (3)) + (1)]) * (local_disp[2]));
double def_grad[0][1] = (def_grad[0][1]) + ((grads[(((1) + ((p) * (2))) * (3)) + (1)]) * (local_disp[3]));
double def_grad[1][1] = (def_grad[1][1]) + ((grads[(((1) + ((p) * (2))) * (3)) + (1)]) * (local_disp[4]));
double def_grad[2][1] = (def_grad[2][1]) + ((grads[(((1) + ((p) * (2))) * (3)) + (1)]) * (local_disp[5]));
double def_grad[0][2] = (def_grad[0][2]) + ((grads[(((0) + ((p) * (2))) * (3)) + (2)]) * (local_disp[0]));
double def_grad[1][2] = (def_grad[1][2]) + ((grads[(((0) + ((p) * (2))) * (3)) + (2)]) * (local_disp[1]));
double def_grad[2][2] = (def_grad[2][2]) + ((grads[(((0) + ((p) * (2))) * (3)) + (2)]) * (local_disp[2]));
double def_grad[0][2] = (def_grad[0][2]) + ((grads[(((1) + ((p) * (2))) * (3)) + (2)]) * (local_disp[3]));
double def_grad[1][2] = (def_grad[1][2]) + ((grads[(((1) + ((p) * (2))) * (3)) + (2)]) * (local_disp[4]));
double def_grad[2][2] = (def_grad[2][2]) + ((grads[(((1) + ((p) * (2))) * (3)) + (2)]) * (local_disp[5]));
