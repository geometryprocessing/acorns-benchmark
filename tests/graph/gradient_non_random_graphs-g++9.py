...
def generate_two_graph(avg_us, avg_them, denom, function, label, num_vars):
    ...
    plt.margins(0, 0)
    plt.savefig('./results/grad/graphs/g++9/non-random/graph_{}_{}.pdf'.format(label, num_vars), bbox_inches='tight',
                pad_inches=0)
...
def generate_full_graph(avg_us, avg_pytorch, avg_wenzel_static, avg_enoki, avg_tapenade, avg_adept, denom, num_vars):
    ...
    plt.margins(0, 0)
    plt.savefig('./results/grad/graphs/g++9/non-random/{}_function_grad_g++9.pdf'.format(num_vars), bbox_inches='tight',
                pad_inches=0)
    plt.clf()
...
wenzel_static_times, wenzel_dynamic_times, enoki_times, pytorch_times, us_times, tapenade_times, adept_times, \
    ...
    "./results/grad/json/non-random/full_results-2020-04-12-18:37:43_without_second_function.json",
